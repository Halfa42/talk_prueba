...
export default function StudentView({ onLogout }) {
  ...
  const renderContent = () => {
        ...
        <div className="space-y-6">
          <div className="grid md:grid-cols-4 gap-4">
            <KpiCard
              title="Nivel actual"
              value="A2"
              hint="Subiste desde A1 diagnóstico"
            />
            <KpiCard
            ...
            <KpiCard
              ...
              value="2"
              hint="Próxima hoy 12:00"
            />
            <KpiCard
              title="Asistencia"
              value="92%"
              hint="Muy buen seguimiento"
            />
          </div>
              ...
              <div className={softCard + " p-5"}>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 rounded-xl bg-slate-50 border">
                    Worksheet de vocabulario — vence mañana
                  </div>
                  <div className="p-3 rounded-xl bg-slate-50 border">
                    Listening exercise — pendiente
                  </div>
                </div>
              </div>
              <div className={softCard + " p-5"}>
    ...
    if (studentModule === "progress")
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold">Mi avance</h2>
            <p className="text-sm text-slate-500">
              Consulta tu progreso de forma clara y sencilla.
            </p>
          </div>
          <div className={softCard + " p-5"}>
      ...
      return (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Recursos organizados por tema para estudiar de manera sencilla.
            </p>
          </div>
    ...
    if (studentModule === "tasks")
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold">Tareas</h2>
            <p className="text-sm text-slate-500">
              Revisa tus actividades y entrega tus trabajos.
            </p>
          </div>
          <div className="grid xl:grid-cols-2 gap-6">
            <div className={softCard + " p-5"}>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-3 rounded-xl bg-slate-50 border">
                  Lectura corta — entregar viernes
                </div>
              </div>
            </div>
            <div className={softCard + " p-5"}>
              ...
              <textarea
                className="w-full rounded-xl border border-slate-300 px-4 py-3 mb-3"
                rows="4"
                placeholder="Comentario para tu tutor"
              />
    ...
    if (studentModule === "classes")
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold">Mis clases</h2>
            <p className="text-sm text-slate-500">
              Consulta tus próximas sesiones y el historial de clases.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {[
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Información personal y académica básica.
          </p>
        </div>
        <div className="grid xl:grid-cols-2 gap-6">
          <div className={softCard + " p-5"}>
          ...
          <div className={softCard + " p-5"}>
            ...
            <div className="space-y-3 text-sm">
              <div className="p-3 rounded-xl bg-slate-50 border">
                Muy buen esfuerzo en la última actividad.
              </div>
              <div className="p-3 rounded-xl bg-slate-50 border">
                Repasa vocabulario antes de la próxima clase.
              </div>
            </div>
          </div>
        </div>
