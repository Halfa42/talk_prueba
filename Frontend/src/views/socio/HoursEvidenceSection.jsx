          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-slate-200">
              {currentEvidencias.map((item) => (
                <tr key={item.id_registro} className="hover:bg-slate-50">
                  <td className="p-4">
                    {new Date(item.fecha_registro).toLocaleDateString()}
                  </td>
                  <td className="p-4">{item.tutor}</td>
                  <td className="p-4 font-semibold">{item.horas}</td>
                  ...
                  <td className="p-4 flex justify-center gap-2">
                    ...
                    <button
                      onClick={() => onDelete(item.id_registro)}
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-slate-200">
              {currentBitacoras.map((b) => (
                <tr key={b.id_bitacora} className="hover:bg-slate-50">
